...
public class ListaPlanoAdaptador extends BaseAdapter {
    private Context context;
    private ArrayList<Plano> planos;
    private LayoutInflater inflater;

    public ListaPlanoAdaptador(Context context, ArrayList<Plano> planos){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_lista_plano, null);
        }
